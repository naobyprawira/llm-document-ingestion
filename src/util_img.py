...
# Maximum dimension (in pixels) for the longest side of the image.
# Set via environment variable ``IMG_MAX_SIDE`` or defaults to 1600.
IMG_MAX_SIDE = int(os.getenv("IMG_MAX_SIDE", "1600"))

# JPEG quality for saved images.  Lower values produce smaller files at
# the expense of quality.  Configurable via ``IMG_JPEG_QUALITY`` env var.
